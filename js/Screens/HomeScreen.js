...
const HomeScreen = ({ navigation }) => {
    ...
    return (<View style={styles.container}>
      <View style={styles.header}>
        <Image source={{ uri: 'https://cnas.ucr.edu/sites/default/files/styles/form_preview/public/default-profile.jpg?itok=UCHDPglp' }} style={styles.profilePic}/>
      ...
      <ScrollView style={styles.scrollView}>
        <TouchableOpacity onPress={handleBudgetPress} style={styles.buttonSection}>
          ...
          <Image source={{ uri: 'https://cdn-icons-png.flaticon.com/512/4604/4604286.png' }} style={styles.ButtonPic}/>
        </TouchableOpacity>
        <TouchableOpacity onPress={handleDormJobsPress} style={styles.buttonSection}>
          ...
          <Image source={{ uri: 'https://cdn-icons-png.flaticon.com/512/5027/5027336.png' }} style={styles.ButtonPic}/>
        </TouchableOpacity>
        <TouchableOpacity onPress={handleMessagePress} style={styles.buttonSection}>
          <Text style={styles.sectionTitle}>Message:</Text>
          <Image source={{ uri: 'https://images.vexels.com/media/users/3/136808/isolated/preview/d3455a22af5f3ed7565fb5fb71bb8d43-send-message-icon.png' }} style={styles.ButtonPic}/>
        </TouchableOpacity>
      </ScrollView>
    </View>);
};
